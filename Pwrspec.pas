...
type
  ...
  private
   ...
   ADC : TLongIntArray ;    { A/D sample data array }
   InBuf : TLongIntArray ;  { A/D sample data array }
   Avg : TLongIntArray ;    { Averaged A/D sample data array }
   Sum : TSingleArray ;      { Summation array (used by ComputeAverage) }
   VarBuf : TSingleArray ; { Ensemble variance array }
   Mean : TSingleArray ;     { Ensemble mean current array }
